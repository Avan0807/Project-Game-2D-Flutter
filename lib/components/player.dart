...
class Player extends SpriteAnimationGroupComponent
    with
        ...
        CollisionCallbacks {
  String character;
  late SoundProvider _soundProvider; // Thêm trường cho SoundProvider
  Player({
    super.position,
    required this.character, // Thay đổi để nhận nhân vật từ bên ngoài
  ...
  void _playerJump(double dt) {
    if (_soundProvider.playSounds) {
      FlameAudio.play('jump.wav', volume: _soundProvider.soundVolume);
    }
  ...
  /*void _respawn() async {
    if (_soundProvider.playSounds) {
      FlameAudio.play('hit.wav', volume: _soundProvider.soundVolume);
    }
  ...
  void _respawn() async {
    ...
    // Thay đổi để chuyển đến trang Game Over
  ...
  void _reachedCheckpoint() async {
    ...
    if (_soundProvider.playSounds) {
      FlameAudio.play('disappear.wav', volume: _soundProvider.soundVolume);
    }
    if (scale.x > 0) {
